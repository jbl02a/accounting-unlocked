      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="rounded-xl bg-white/5 border border-white/10 p-5 mb-6">
          ...
          <div className="rounded-lg border border-white/10 overflow-hidden mb-4">
            <div className="grid grid-cols-[6.5rem_1fr_1fr] bg-slate-800 text-[10px] font-bold text-dim uppercase tracking-wider px-3 py-2 gap-2">
        ...
        {q.options.map((opt, i) => {
          ...
          return (
            <button key={i} onClick={() => choose(i)} disabled={chosen !== null} className={`${base} ${state}`}>
              <div className="flex items-start gap-3">
                <span className="text-xs font-bold text-dim mt-1 shrink-0">{'ABCD'[i]}</span>
