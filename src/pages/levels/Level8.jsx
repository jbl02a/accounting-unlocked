    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-slate-300">Journal entries are a diary in date order. To build a trial balance you need each account gathered in one place and totaled — that is the ledger.</p>
        </div>
        ...
        <div className="rounded-xl bg-white/5 border border-white/10 p-5 mb-6">
          ...
          <div className="rounded-lg bg-slate-900/60 border border-white/10 p-4">
            ...
            <p className="text-center text-xs text-slate-300 mt-1">The debit side is bigger, so the balance is a debit — exactly what an asset should be.</p>
          </div>
        </div>

        <div className="rounded-xl bg-white/5 border border-white/10 p-5 mb-6">
          <h3 className="font-bold text-white mb-1">Normal balances — memorize this table</h3>
          <p className="text-xs text-slate-300 mb-3">A &ldquo;normal balance&rdquo; is the side an account is supposed to land on. If yours lands on the other side, something is usually wrong.</p>
    ...
    return (
      <div className="max-w-xl mx-auto">
        <div className="text-center mb-6">
          ...
          {hints.usedCount > 0 && <p className="text-xs text-slate-300">{hintTally(hints.usedCount)}</p>}
        </div>

        <div className="rounded-xl bg-white/5 border border-white/10 p-5 mb-6">
          <p className="font-bold text-white mb-1">Here is Beacon Tutoring&rsquo;s whole ledger</p>
          <p className="text-xs text-slate-300 mb-3">Every account balance, on its normal side. Look what happens when you add the columns.</p>
          ...
          <p className="text-xs text-slate-300 text-center mt-1">That list, put in the right order, IS a trial balance. That is Level 9.</p>
        </div>
