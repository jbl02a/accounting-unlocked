    ...
    return (
      <div className="max-w-2xl mx-auto">
        ...
        <div className="rounded-xl overflow-hidden border border-white/10 mb-8">
          <div className="grid grid-cols-3 bg-slate-800 text-xs font-bold text-dim uppercase tracking-wider px-4 py-2">
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm text-dim">Question {current + 1} of {QUESTIONS.length}</span>
